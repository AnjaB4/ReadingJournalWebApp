...
/** @var $books BookModel */ // lista knjiga koja se prosledjuje iz kontrolera
?>

<div class="card">
    <form action="/processCreateLog" method="post">
        <div class="card-header pb-0">
            <div class="d-flex align-items-center">
                <p class="mb-0">Create new log</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="floatingSelect" name="id_book">
