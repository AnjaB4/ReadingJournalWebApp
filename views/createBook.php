 ...
 */
//nasi params sadrze podatke o gresci ovde
?>

<div class="card">
    <form action="/processCreateBook" method="post">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!--                    ovaj div (i svaki slicni) moze u core/Forms da se automatizuje-->
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="page_count" value="<?= $book->page_count ?>"
                               onfocus="focused(this)" onfocusout="defocused(this)">
                        <?php
                        if ($book != null && $book->errors != null) {
                            foreach ($book->errors as $attribute => $error) {
